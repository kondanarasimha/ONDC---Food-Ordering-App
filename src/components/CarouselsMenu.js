  ...
  return(
      <div>
        ...
        <div className="flex justify-between w-48 pl-4 pr-1 absolute z-40 -mt-9">
          {price === undefined ? <h5 className="text-white shadow-sm text-md font-semibold">₹{(defaultPrice/100).toFixed()}</h5> : <h5 className="text-white shadow-md text-sm font-semibold">₹{(price/100).toFixed()}</h5>}
